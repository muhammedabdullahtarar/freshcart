       ...
       <nav class="navbar navbar-light py-2">
          <div class="container justify-content-center justify-content-lg-between">
             <a class="navbar-brand" href="{{ url('/') }}">
                <img src="{{ asset('images/freshcart-logo.svg') }}" alt="" class="d-inline-block align-text-top">
             </a>
                   ...
                   <form id="formSignin">
                      <div class="row g-3">
                         <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="formSigninEmail" placeholder="Email">
                         </div>
                         <div class="col-12">
                            <div class="password-field position-relative">
                               <label for="formSigninPassword" class="form-label visually-hidden">Password</label>
                               <input type="password" class="form-control fakePassword" id="formSigninPassword" placeholder="*****">
                            </div>
                         </div>
                         <div class="d-flex justify-content-between">
                            ...
                            <div>
                               Forgot password?
                               <a href="{{ route('forgot-password') }}">Reset It</a>
                            </div>
                         </div>
             ...
             <div class="row align-items-center">
                <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
                   <ul class="list-inline mb-0">
                      ...
                      <li class="list-inline-item">
                         <a href="#!"><img src="{{ asset('images/american-express.svg') }}" alt=""></a>
                      </li>
                      <li class="list-inline-item">
                         <a href="#!"><img src="{{ asset('images/mastercard.svg') }}" alt=""></a>
                      </li>
                      <li class="list-inline-item">
                ...
                <div class="col-lg-7 mt-4 mt-md-0">
                   <ul class="list-inline mb-0 text-lg-end text-center">
                      ...
                      <li class="list-inline-item ms-4">
                         <a href="#!"><img src="{{ asset('images/appstore-btn.svg') }}" alt="" style="width: 140px"></a>
                      </li>
                      <li class="list-inline-item">
                         <a href="#!"><img src="{{ asset('images/googleplay-btn.svg') }}" alt="" style="width: 140px"></a>
                      </li>
                   </ul>
                </div>
             </div>
