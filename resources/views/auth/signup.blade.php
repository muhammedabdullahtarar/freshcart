                        ...
                        <form class="" id="formSignup">
                            <div class="row g-3">
                                ...
                                <div class="col">
                                    ...
                                    <div class="invalid-feedback" id="formSignupfnameError"></div>
                                </div>
                                <div class="col">
                                    ...
                                    <div class="invalid-feedback" id="formSignuplnameError"></div>
                                </div>
                                <div class="col-12">

                                    <label for="formSignupEmail" class="form-label visually-hidden">Email
                                        address</label>
                                    <input type="text" class="form-control" id="formSignupEmail" placeholder="Email" name="email">
                                    <div class="invalid-feedback" id="formSignupEmailError"></div>
                                </div>
                                <div class="col-12">
                                    <div class="password-field position-relative">
                                        ...
                                        <div class="password-field position-relative">
                                            <input type="password" class="form-control fakePassword"
                                                id="formSignupPassword" placeholder="*****" name="password">
                                            <div class="invalid-feedback" id="formSignupPasswordError"></div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item mb-2"><a href="#!" class="nav-link">Cold drinks & juices</a>
                                </li>
                                <li class="nav-item mb-2"><a href="#!" class="nav-link">Tea, coffee & drinks</a>
                                </li>
                    ...
                    <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-inline-item">
                                <a href="#!"><img src="{{ asset('images/amazonpay.svg') }}" alt=""></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="#!"><img src="{{ asset('images/american-express.svg') }}"
                                        alt=""></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="#!"><img src="{{ asset('images/mastercard.svg') }}"
                                        alt=""></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="#!"><img src="{{ asset('images/paypal.svg') }}" alt=""></a>
                            </li>
                            <li class="list-inline-item">
                    ...
                    <div class="col-lg-7 mt-4 mt-md-0">
                        <ul class="list-inline mb-0 text-lg-end text-center">
                            ...
                            <li class="list-inline-item ms-4">
                                <a href="#!"><img src="{{ asset('images/appstore-btn.svg') }}" alt=""
                                        style="width: 140px"></a>
                            </li>
                            <li class="list-inline-item">
                                <a href="#!"><img src="{{ asset('images/googleplay-btn.svg') }}" alt=""
                                        style="width: 140px"></a>
                            </li>
                        </ul>
                    </div>
