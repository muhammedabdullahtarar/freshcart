...
<body>
            ...
            <div class="container">
                <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default"
                    ...
                    <div class="offcanvas-header pb-1">
                        <a href="{{ url('/') }}"><img src="{{ asset('images/freshcart-logo.svg') }}"
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            <div>
                <!-- alert -->
                <div class="alert alert-danger p-2" role="alert" style="display: block;">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item py-3 ps-0 border-top">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 col-md-6 col-lg-7">
                                <div class="d-flex">
                                    <img src="images/product-img-1.jpg" alt="Ecommerce" class="icon-shape icon-xxl">
                                    <div class="ms-3">
                                        <!-- title -->
                    ...
                    <li class="list-group-item py-3 ps-0">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6 col-md-6 col-lg-7">
                                <div class="d-flex">
                                    <img src="images/product-img-2.jpg" alt="Ecommerce" class="icon-shape icon-xxl">
                                    <div class="ms-3">
                                        <a href="./pages/shop-single.html" class="text-inherit">
                    ...
                    <li class="list-group-item py-3 ps-0">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6 col-md-6 col-lg-7">
                                <div class="d-flex">
                                    <img src="images/product-img-3.jpg" alt="Ecommerce" class="icon-shape icon-xxl">
                                    <div class="ms-3">
                                        <!-- title -->
                                        <a href="./pages/shop-single.html" class="text-inherit">
                    ...
                    <li class="list-group-item py-3 ps-0">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6 col-md-6 col-lg-7">
                                <div class="d-flex">
                                    <img src="images/product-img-4.jpg" alt="Ecommerce" class="icon-shape icon-xxl">
                                    <div class="ms-3">
                                        <!-- title -->
                                        <!-- title -->
                                        <a href="./pages/shop-single.html" class="text-inherit">
                    ...
                    <li class="list-group-item py-3 ps-0 border-bottom">
                        ...
                        <div class="row align-items-center">
                            <div class="col-6 col-md-6 col-lg-7">
                                <div class="d-flex">
                                    <img src="images/product-img-5.jpg" alt="Ecommerce" class="icon-shape icon-xxl">
                                    <div class="ms-3">
                                        <!-- title -->
                                        <a href="./pages/shop-single.html" class="text-inherit">
        ...
        <section class="mt-8">
            <div class="container">
                <div class="hero-slider">
                    <div
                        style="background: url({{ asset('images/slide-1.jpg') }}) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                    ...
                    <div
                        style="background: url({{ asset('images/slider-2.jpg') }}) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                        <div class="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">
                ...
                <div class="category-slider">
                        ...
                        <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
                            <div class="card card-product mb-lg-4">
                                <div class="card-body text-center py-8">
                                    <img src="images/category-dairy-bread-eggs.jpg" alt="Grocery Ecommerce Template"
                    ...
                    <div class="item">
                        <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
                            <div class="card card-product mb-lg-4">
                                <div class="card-body text-center py-8">
                                    <img src="images/category-snack-munchies.jpg" alt="Grocery Ecommerce Template"
                                        class="mb-3">
                    ...
                    <div class="item">
                        <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
                            <div class="card card-product mb-lg-4">
                                <div class="card-body text-center py-8">
                                    <img src="images/category-bakery-biscuits.jpg" alt="Grocery Ecommerce Template"
                                        class="mb-3">
                    ...
                    <div class="item">
                        <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
                            <div class="card card-product mb-lg-4">
                                <div class="card-body text-center py-8">
                                    <img src="images/category-instant-food.jpg" alt="Grocery Ecommerce Template"
                                        class="mb-3">
                    ...
                    <div class="item">
                        <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
                            <div class="card card-product mb-lg-4">
                                <div class="card-body text-center py-8">
                                    <img src="images/category-tea-coffee-drinks.jpg" alt="Grocery Ecommerce Template"
                                        class="mb-3">
                    ...
                    <div class="item">
                        <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
                            <div class="card card-product mb-lg-4">
                                <div class="card-body text-center py-8">
                                    <img src="images/category-atta-rice-dal.jpg" alt="Grocery Ecommerce Template"
                                        class="mb-3">
                    ...
                    <div class="item">
                        <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
                            <div class="card card-product mb-lg-4">
                                <div class="card-body text-center py-8">
                                    <img src="images/category-baby-care.jpg" alt="Grocery Ecommerce Template"
                                        class="mb-3">
                    ...
                    <div class="item">
                        <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
                            <div class="card card-product mb-lg-4">
                                <div class="card-body text-center py-8">
                                    <img src="images/category-chicken-meat-fish.jpg" alt="Grocery Ecommerce Template"
                                        class="mb-3">
                    ...
                    <div class="item">
                        <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
                            <div class="card card-product mb-lg-4">
                                <div class="card-body text-center py-8">
                                    <img src="images/category-cleaning-essentials.jpg"
                    ...
                    <div class="item">
                        <a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
                            <div class="card card-product mb-lg-4">
                                <div class="card-body text-center py-8">
                                    <img src="images/category-pet-care.jpg" alt="Grocery Ecommerce Template"
                                        class="mb-3">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-12 col-md-6 mb-3 mb-lg-0">
                     <div>
                        <div class="py-10 px-8 rounded" style="background: url(images/grocery-banner.png) no-repeat; background-size: cover; background-position: center">
                           <div>
                  ...
                  <div class="col-12 col-md-6">
                     <div>
                        <div class="py-10 px-8 rounded" style="background: url(images/grocery-banner-2.jpg) no-repeat; background-size: cover; background-position: center">
                           <div>
                        ...
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    ...
                                    <a href="#!"><img src="images/product-img-1.jpg"
                        ...
                        <div class="card card-product">
                            <div class="card-body">
                                <div class="text-center position-relative">
                                    ...
                                    <a href="./pages/shop-single.html"><img src="images/product-img-2.jpg"
                                            alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                                    <div class="card-product-action">
                                        <a href="#!" class="btn-action" data-bs-toggle="modal"
                                            data-bs-target="#quickViewModal">
                    ...
                    <div class="row row-cols-lg-4 row-cols-1 row-cols-md-2 g-4 flex-nowrap">
                        <div class="col">
                            <div class="pt-8 px-6 px-xl-8 rounded"
                                style="background: url(images/banner-deal.jpg) no-repeat; background-size: cover; height: 470px">
                                <div>
                        ...
                        <div class="col">
                            <div class="card card-product">
                                <div class="card-body">
                                    <div class="text-center position-relative">
                                        <a href="./pages/shop-single.html"><img src="images/product-img-11.jpg"
                                                alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                        ...
                        <div class="col">
                            <div class="card card-product">
                                <div class="card-body">
                                    <div class="text-center position-relative">
                                        <a href="./pages/shop-single.html"><img src="images/product-img-12.jpg"
                                                alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                                        <div class="card-product-action">
                                            <a href="#!" class="btn-action" data-bs-toggle="modal"
                                                data-bs-target="#quickViewModal">
                        ...
                        <div class="col">
                            <div class="card card-product">
                                <div class="card-body">
                                    <div class="text-center position-relative">
                                        <a href="./pages/shop-single.html"><img src="images/product-img-13.jpg"
                                                alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                                        <div class="card-product-action">
                                            <a href="#!" class="btn-action" data-bs-toggle="modal"
                                                data-bs-target="#quickViewModal">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="mb-8 mb-xl-0">
                            <div class="mb-6"><img src="images/clock.svg" alt=""></div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="mb-8 mb-xl-0">
                            <div class="mb-6"><img src="images/gift.svg" alt=""></div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="mb-8 mb-xl-0">
                            <div class="mb-6"><img src="images/package.svg" alt=""></div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="mb-8 mb-xl-0">
                            <div class="mb-6"><img src="images/refresh-cw.svg" alt=""></div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product productModal" id="productModal">
                                <div class="zoom" onmousemove="zoom(event)"
                                    ...
                                    <!-- img -->
                                    <img src="images/product-single-img-1.jpg" alt="">
                                </div>
                                <div>
                                    <div class="zoom" onmousemove="zoom(event)"
                                        style="background-image: url(images/product-single-img-2.jpg)">
                                        <!-- img -->
                                        <img src="images/product-single-img-2.jpg" alt="">
                                    </div>
                                </div>
                                <div>
                                    <div class="zoom" onmousemove="zoom(event)"
                                        ...
                                        <!-- img -->
                                        <img src="images/product-single-img-3.jpg" alt="">
                                    </div>
                                </div>
                                <div>
                                    <div class="zoom" onmousemove="zoom(event)"
                                        ...
                                        <!-- img -->
                                        <img src="images/product-single-img-4.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- product tools -->
